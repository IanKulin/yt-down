...
const DEFAULT_SETTINGS = {
  videoQuality: '720p', // 720p, 1080p, 1440p, 2160p, no-limit
  subtitles: true,
  autoSubs: false,
  subLanguage: 'en',
  rateLimit: '360K', // no-limit, 180K, 360K, 720K, 1440K
  titleEnhancement: {
    enabled: true,
    maxTitleChecks: 2,
    pollInterval: 2000,
...
export async function getYtDlpArgs(url) {
  ...
  // Ensure final output is MP4 with h.264 when merging separate video/audio streams
